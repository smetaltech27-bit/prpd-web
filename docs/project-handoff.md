...
- ชื่อหัวคอลัมน์ทุกช่องในตาราง Raw Material จัดกึ่งกลางแนวนอน ส่วนข้อมูล No., Item FG, Code RM, Type, จำนวนผลิต, Q’ty, Price และปุ่มจัดการจัดกึ่งกลางให้ตรงแนวคอลัมน์ ขณะที่ Vendor, Name Part, Dimension และ Comment คงชิดซ้ายเพื่ออ่านข้อความยาวง่าย
